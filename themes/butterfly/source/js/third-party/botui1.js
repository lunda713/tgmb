...
function bot_ui_ini() {
  ...
  var sure = function() {
    ...
    secondpart = function() {
      botui.message.add({
        delay: 1500,
        content: "首先呢，很感谢您肯在这里驻足片刻。Akilarの糖果屋是一个个人性质的博客，我会在这里发表各种各样的内容。"
      }).then(function() {
        botui.message.add({
          delay: 1500,
          ...
          botui.message.add({
            delay: 1200,
            content: "在这里有很多内容，我会一一细说。"
          }).then(function() {
            botui.message.add({
              delay: 1500,
              content: "Akilarの巧克力 是我为ubuntu写的教程贴，为什么是巧克力呢？因为巧克力一般是黑的，ubuntu的发音乌班图，其名称来自非洲南部祖鲁语或豪萨语的“ubuntu”一词 ，类似儒家“仁爱”的思想，意思是“人性”。但那不重要，我只不过是因为这个“乌”字让我想到了黑巧克力而已。哦，对，我只喜欢黑巧克力，太甜的对牙齿不好。"
            }).then(function() {
              botui.message.add({
                delay: 1500,
                content: "Akilarの棉花糖是我为win10写的教程贴，棉花糖没什么意味，毕竟一般棉花糖是白的吧？哈哈哈。"
              }).then(function() {
                botui.message.add({
                  delay: 1800,
                  content: "Akilarの糖葫芦就是通用教程了，这个非常驳杂，但是我保证都很实用，作为一个程序员预备役，我始终坚信一个美观的开发环境能够增加写代码的乐趣。"
                }).then(function() {
                  botui.message.add({
                    delay: 1500,
                    content: "Akilarの泡泡糖**是连载了几乎一整个2018年的日记，将近30w字的流水账。暂时停更了，主要是因为我觉得生活有些千篇一律，每年就过这么些东西。"
                  }).then(function() {
                        botui.message.add({
                          delay: 1500,
                          content: "Akilarの太妃糖**既是最后也是我最喜欢的，虽然我专业选择了软件工程，但是我骨子里还是热爱文学的。这里每一篇微小说都取材自我儿时的那些人那些记忆。而我对于时间一直有着一种痴迷。"
                }).then(function() {
                  botui.action.button({
                    delay: 1100,
                    action: [{
                      text: "emmm，其实我更想看自我介绍，比如为什么叫Akilar🤔",
                      value: "why-mashiro"
                    }]
                  }).then(function(a) {
                    thirdpart()
    ...
    thirdpart = function() {
      botui.message.add({
        delay: 1e3,
        content: "Akilar是我的名字的日文发音的谐音拼写，灵感来源于刀剑神域。"
      }).then(function() {
        botui.action.button({
          delay: 1500,
          action: [{
    ...
    fourthpart = function() {
      botui.message.add({
        delay: 1e3,
        content: "我的名字在日文中有个发音是Akira,就用英文谐音拼写出来。"
      }).then(function() {
        botui.message.add({
          delay: 1100,
          content: "灵感来源于刀剑神域，哈哈哈~"
        }).then(function() {
          botui.action.button({
            delay: 1500,
            action: [{
